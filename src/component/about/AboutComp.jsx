    ...
    <div className='container'>
        ...
        <div className="container about" id='about'>
            <div className='justify-content-center p-2'>
                ...
                <div className='col-md-8 mx-auto aboutPicture my-4'>
                    <div className='col mx-auto aboutBlockPicture'>
                    ...
                    <div className='col aboutBlockPicture justify-content-center'>
                    ...
                    <div className='col aboutBlockPicture'>
                ...
                <div className='aboutBlock col-md-8 mx-auto p-4'>
                    <div className='aboutBlockDetail col'>
