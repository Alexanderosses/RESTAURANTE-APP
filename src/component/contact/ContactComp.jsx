  ...
  return (
    <div className="container contact mt-5" id='contact'>
        <div className="col-md-8 mx-auto">
            <div>
                <h2 className='titleContact mt-5 mb2'>Datos de contacto</h2>
                <h3 className='textContact'>En Restobar Snacky estamos para atender tus consultas.</h3>
            </div>
            <div className='contactBlock pt-4'>
                <div className='col contactBlockIcon'>
                    ...
                    <span className='textContactIcon textContactBold pb-2'>Estamos ubicados en:</span>
                ...
                <div className='col contactBlockIcon'>
                    ...
                    <span className='textContactIcon textContactBold pb-2'>Teléfonos</span>
                ...
                <div className='col contactBlockIcon'>
                    ...
                    <span className='textContactIcon textContactBold pb-2'>Email</span>
